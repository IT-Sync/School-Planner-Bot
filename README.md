...
Для ежедневных проверяемых копий, выгрузки на другой сервер и контроля
восстановления используйте [инструкцию автоматического резервного
копирования](docs/automated-backups.md).
...
План репетиции, переключения и отката находится в [инструкции миграции
PostgreSQL 15 → 16](docs/postgres-16-migration.md).
